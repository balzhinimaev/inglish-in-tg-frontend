            ...
            <div className="grid grid-cols-3 gap-3 mt-4">
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <span className="text-xs text-green-600">Выучено</span>
                </div>
                <div className="text-lg font-bold text-green-800">{stats.learned}</div>
              </div>
              
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-xs text-green-600">Изучается</span>
                </div>
                <div className="text-lg font-bold text-green-800">{stats.learning}</div>
              </div>
              
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <div className="w-2 h-2 bg-gray-400 rounded-full"></div>
                  <span className="text-xs text-green-600">Осталось</span>
                </div>
                <div className="text-lg font-bold text-green-800">{stats.notStarted}</div>
              </div>
            </div>
          </div>
        </div>
